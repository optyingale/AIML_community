...
def decode_multiple_poses(
    ...
    # print(np.array(scored_parts).shape[0]) # Rows keep changing
    ...
    for root_score, root_id, root_coord in scored_parts:
        ...
        if pose_count >= max_pose_detections:
            break
    # print(pose_keypoint_coords[0])
    # It gets all the coordinates having confirmed only a few
